...
const PRODUCTS: Product[] = [
  {
    ...
    summary:
      "High-grade hematite ore for steelmaking and sintering applications; stable Fe content with controlled sizing and low moisture for reliable furnace performance.",
  ...
  },
  {
    ...
    summary:
      "High-grade magnetite ore suitable for pelletizing, steelmaking, and beneficiation; consistent Fe content with stable sizing, magnetic separability, and controlled moisture for efficient processing.",
    specs: ["Fe 58–64%+", "Size: 0–10 / 10–50 mm", "Moisture ≤ 8%"],
    grade: "Fe 58–64%+",
    minOrderMt: 25,
  },
  ...
  },
  {
    ...
    summary:
      "Scheelite-based tungsten ore suitable for hard-metal, alloy, and tooling applications; stable WO₃ grades with controlled moisture and reliable concentrate sizing.",
  ...
  },
  {
    ...
    summary:
      "Wolframite-rich tungsten ore for hard-metal, alloy, and tooling production; high WO₃ content with controlled impurity levels and consistent concentrate sizing for stable metallurgical performance.",
    specs: ["WO3 20–50% (concentrate)", "Moisture ≤ 10%"],
    grade: "WO3 20–50%",
    minOrderMt: 25,
  },
  ...
  },
  {
    ...
    summary:
      "High-quality muscovite mica for electrical, cosmetic, and industrial applications; stable color, flake size, and low impurity levels.",
  ...
  },
  {
    ...
    summary:
      "High-performance phlogopite mica for electrical insulation, refractory linings, and industrial applications; thermally stable with consistent flake size and low iron content.",
    specs: ["Flake size on request", "Low impurity"],
    grade: "Industrial",
    minOrderMt: 25,
  },
  ...
  },
  {
    ...
    summary:
      "High-purity quartz for glass, foundry, and industrial applications; low contaminant levels.",
  ...
  },
  {
    ...
    summary:
      "High-purity silica for glass manufacturing, foundry use, and industrial processing; consistent chemistry and minimal impurities.",
    specs: ["SiO2 97–99%+", "Size: Lumpy / Mesh"],
    grade: "SiO2 97–99%+",
    minOrderMt: 25,
  },
